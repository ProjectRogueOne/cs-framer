	...
	for letter, i in newFirstText
		do (letter, i) ->
			Utils.delay (i * TYPE_DELAY), ->
				...
				unless i is (newFirstText.length - 1) and lastInCycle
					changeText2._element.childNodes[1].childNodes[0].appendChild(cursor)
...
setFirstLine = ->
	...
	Utils.delay firstDelay, ->
		changeText1._element.childNodes[1].childNodes[0].removeChild(cursor)
		setSecondLine()
	...
	for letter, i in newSecondText
		do (letter, i) ->
			Utils.delay (i * TYPE_DELAY), ->
				...
				unless i is (newSecondText.length - 1) and lastInCycle
					changeText2._element.childNodes[1].childNodes[0].appendChild(cursor)
