...
ERROR_TEXT_ONLY = true
MOVE_BACKGROUND_ON_ERROR = true
...
email.on "change:value", vertify

# email warning tool tip
...
submitButton.on "change:y", ->
	cancelLink.y = submitButton.maxY + 32
