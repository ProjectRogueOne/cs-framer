...
savingsView.build ->
	...
	yourCurrentSlider = new RangeSliderComponent
		parent: currentScore
		x: 16, y: yourCurrentScore.maxY + 32
		width: @width - 32
		min: 0
		max: 700
		minValue: 300
	...
	yourCurrentScore.mid
	
	yourCurrentSlider.minKnob.draggable.propagateEvents = false
	yourCurrentSlider.maxKnob.draggable.propagateEvents = false
