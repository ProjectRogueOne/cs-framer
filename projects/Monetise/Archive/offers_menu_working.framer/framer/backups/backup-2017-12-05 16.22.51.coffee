...
categoryView.build ->
	...
	app.header.on "change:y", =>
		@subnav.y = app.header.maxY - @y - app.header.height
...
singleView.build ->
	...
	@content.onMove => 
		if @footer.screenFrame.y <= @inlineFooter.screenFrame.y and @footer.visible is false
			@footer.visible = true
		else if @footer.screenFrame.y > @inlineFooter.screenFrame.y and @footer.visible is true
