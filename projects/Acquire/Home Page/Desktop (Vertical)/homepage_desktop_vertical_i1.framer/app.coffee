...
NAV_LINKS = [
	{text: "Credit score explained", page: -> pages[1]}
	{text: "Build your score", page: -> pages[2]}
	{text: "Get the best offers", page: -> pages[3]}
	{text: "Your full report", page: -> pages[4]}
...
Utils.bind homeView, ->
	navButtons = SELECT_NAV_LINKS.map (link, i) =>
		new Body2Link
			parent: @content
			y: 52
			x: Align.right()
	...
	signIn = new Button
		parent: @content
		x: Align.right(-44 - register.width - 16)
		y: 52
		text: "Sign In"
...
# 	Logo
	...
	logo.onTap -> window.location.reload()
...
# 		return if headerOpen is true
# 		homeView.open()
# 		return
# 		
# 	return if headerOpen is false
# 	homeView.close()
# 	
