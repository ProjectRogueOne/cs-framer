...
singleView.build ->
	...
	@content.onMove => 
		print @scrollY
		if @scrollY > 688 and @footer.parent is @
			@footer.parent = null
			@footer.parent = @content
			Utils.delay 0, => 
				@footer.y = static_view_single.maxY
				
		else if @scrollY <= 688 and @footer.parent is @content
			@footer.parent = null
			
			Utils.delay 0, => 
				@footer.parent = @
				@footer.maxY = (app.footer?.y ? Screen.height)
