...
exports.Context = Context =
	...
	setMobile: ->
		...
		exports.Caption = Mobile.Caption
		...
		Context.setDevice() if Framer.Device.deviceType is 'custom'
	...
	setDevice: (deviceType = "apple-iphone-7-black") ->
	...
	setStandard: ->
		...
		exports.Caption = Standard.Caption
