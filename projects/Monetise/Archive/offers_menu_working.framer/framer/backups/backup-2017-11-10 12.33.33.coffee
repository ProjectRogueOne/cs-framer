...
postcodeView.build ->
	puller = new cs.Puller
		parent: @content
		text: 'You can quickly search fro your address by using just your postcode. In case we can’t find your address you can always enter it manually.'
		
	@padding.top = puller.maxY + 16
		
	@addToStack @addressField = new cs.Field
	...
	@addToStack @manualOption = new Layer
