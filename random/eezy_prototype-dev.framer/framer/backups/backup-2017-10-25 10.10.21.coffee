...
for layer in [Fiber, description, eezy_pet, facebook, login_button, email_signup]
	layer.opacity = 0
...
facebook.onTap ->
	flow.showOverlayBottom(fb_login)
...
sideChat.subject = "a stickersheet"

# ---------------------
# Callback Script
	
sideChatgreeting = ->
	sideChat.addChat new ChatBubble
		text: 'This chat is for ' + sideChat.subject
...
showChatGiphy = ->
	sideChat.addChat new ChatGiphy
		query: 'welcome'
...
showTextChoice = ->
	...
	sideChat.addChat new TextChoiceBox
...
showLinkChoiceBox = ->
	...
	sideChat.addChat new LinkChoiceBox
		link: link
...
showLinkChoiceScroll = ->
	...
	sideChat.addChat new LinkChoiceScroll
...
showPersonChoiceScroll = ->
	sideChat.addChat new PersonChoiceScroll
		chatView: sideChat
...
showGridChoice = ->
	...
	sideChat.addChat new GridChoiceContainer
		chatView: sideChat
		choices: foodChoices
