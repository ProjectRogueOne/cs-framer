...
offers.scrollVertical = false
offers.propagateEvents = false
...
for button, i in [
	...
	cardButton = new OfferButton
		...
		icon: button.icon
		title: button.title
		value: if SHOW_PROGRESS then button.value
...
for button, i in [
	{title: 'Credit Cards', icon: 'cards'},
	{title: 'Loans', icon: 'bankloans'},
	{title: 'Car Finance', icon: 'autoloans'},
	{title: 'Mortages', icon: 'mortages'},
	{title: 'Credit Cards', icon: 'cards'},
	{title: 'Loans', icon: 'bankloans'},
	{title: 'Car Finance', icon: 'autoloans'},
	{title: 'Mortages', icon: 'mortages'},
