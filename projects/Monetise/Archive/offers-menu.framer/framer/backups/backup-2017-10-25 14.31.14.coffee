...
singleView.build ->
	...
	@content.onMove => 
		if @footer.screenFrame.y <= @inlineFooter.screenFrame.y and @footer.visible is true
			@footer.visible = false
		else if @footer.screenFrame.y > @inlineFooter.screenFrame.y and @footer.visible is false
			@footer.visible = true
